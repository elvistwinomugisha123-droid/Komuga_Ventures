        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-blue-800 text-blue-200 transition-colors hover:bg-blue-700 hover:text-white"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-blue-800 text-blue-200 transition-colors hover:bg-green-600 hover:text-white"
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-blue-200">
              <li>{COMPANY.phone} (WhatsApp & Call)</li>
