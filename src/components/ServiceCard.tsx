  ...
  leaf: (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 21c-4-4-8-7.5-8-12a8 8 0 0116 0c0 4.5-4 8-8 12z"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M12 13V7m0 0l-2 2m2-2l2 2"
      />
    </svg>
  ),
  cpu: (
...
export default function ServiceCard({ service }: { service: Service }) {
  return (
    <div className="group rounded-2xl border border-slate-200 bg-white p-6 transition-shadow hover:shadow-lg">
      <div className="mb-4 inline-flex rounded-lg bg-blue-50 p-3 text-blue-700 transition-colors group-hover:bg-blue-700 group-hover:text-white">
        {icons[service.icon] ?? icons.chart}
      </div>
